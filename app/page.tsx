...
import {
  ...
  SquareIcon,
  StripeIcon,
} from "@/app/components/brand-icons";
...
const LogoStrip = () => {
  const logos = [
    { name: "AWS", Icon: AwsIcon, iconClass: "h-8 w-auto", showLabel: false },
    { name: "Stripe", Icon: StripeIcon, iconClass: "h-6 w-auto", showLabel: true },
    { name: "OpenAI", Icon: OpenAiIcon, iconClass: "h-6 w-6", showLabel: true },
    { name: "Gemini", Icon: GeminiIcon, iconClass: "h-6 w-6", showLabel: true },
    { name: "Square", Icon: SquareIcon, iconClass: "h-6 w-6", showLabel: true },
    { name: "Clover", Icon: CloverIcon, iconClass: "h-6 w-6", showLabel: true },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-12">
          ...
          <div className="flex flex-wrap items-center gap-x-10 gap-y-6 lg:gap-x-14 text-stone-400 dark:text-zinc-600">
            {logos.map(({ name, Icon, iconClass, showLabel }) => (
              <div
                key={name}
                className="flex items-center gap-2 transition-colors hover:text-stone-700 dark:hover:text-zinc-300"
              >
  ...
  return (
    <div className="relative min-h-screen bg-white dark:bg-zinc-950 text-stone-900 dark:text-white font-body selection:bg-indigo-200 dark:selection:bg-indigo-900/40 overflow-x-hidden">
      ...
      <div className="relative z-10">
        <Navbar glassEffect hideOnScroll launchBadge="Now in early access" />
        <main>
          <Hero />
          <LogoStrip />
          <Features />
